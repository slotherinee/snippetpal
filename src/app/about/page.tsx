				...
				<div className="container grid items-center justify-center gap-4 px-4 md:px-6 lg:grid-cols-2 lg:gap-10">
					<div className="space-y-4">
						...
						<p className="max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
							...
							understanding of the world around them. We believe in the power of
							storytelling to inspire, educate, and connect people.
						</p>
					</div>
					<Image
						src="/about2.jpg"
				...
				<div className="container grid items-center justify-center gap-4 px-4 md:px-6 lg:grid-cols-2 lg:gap-10">
					...
					<div className="space-y-4">
						...
						<p className="max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
							...
							creators who are passionate about sharing captivating stories and
							insightful perspectives. We come from diverse backgrounds and
							bring a wealth of experience to the table, united by our love for
							the written word.
						</p>
					</div>
				</div>
					...
					<div className="space-y-4">
						...
						<div className="grid gap-6">
							...
							<div className="grid gap-1">
								...
								<p className="text-muted-foreground">
									Our team provides in-depth analysis and unique perspectives on
									the topics we cover.
								</p>
							</div>
						</div>
